#'
#' Project Data Points Onto an Axis
#'
...
#' @return A list of two data frames, containing the projections onto each axis.
#'
...
project_data_onto_axes <- function(data = NULL, axes = NULL, plot = FALSE) {
  ...
  # trap here for 0, 180, etc, or earlier?
  ...
  return(list("axis_1_projection" = proj_1c[1:2,],
