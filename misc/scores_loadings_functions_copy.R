...
plot_rot_axes = function(file, show_rotated = TRUE,
  ...
  points(x = file$axis1_x, y = file$axis1_y, 
         pch = 19, col = axis1_col, cex = 0.75)
  points(x = file$axis2_x, y = file$axis2_y, 
         pch = 19, col = axis2_col, cex = 0.75)
  }
  ...
  text(x = 10.7, y = 2.5, 
       labels = expression(Phi), cex = 1.25, col = axis1_col)
